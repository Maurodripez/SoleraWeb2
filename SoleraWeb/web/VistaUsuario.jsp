...
<html lang="en">
    ...
    <body class="p-2">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table table-striped align-middle table-responsive table-hover col float-end text-center">
                            <thead>
                                <tr>
        ...
        <div
            ...
            id="modalDocumentos"
            tabindex="-1"
            aria-labelledby="modalDocumentosLabel"
            aria-hidden="true"
        >
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="accordion" id="accordionDocumentos">
                            <div class="accordion-item panelImagen">
                                ...
                                class="formImagenes"
                                    ...
                                    method="post"
                                    id="cargaIdentificacion"
                                    onsubmit="return userSubmit()"
                                >
                                    <h2 class="accordion-header" id="headingOne">
                                        <button onclick="mortrarImagen()"
                                            class="accordion-button"
                                            type="button"
                                            data-bs-toggle="collapse"
                                            data-bs-target="#identifiacion"
                                            aria-expanded="true"
                                        ...
                                        <div id="imagenIdentificacion" class="accordion-body ">
                                            <div class="row">
                                                <div class="mb-0 col-10">
                                                    <label for="imgIdentificacion" class="form-label">
                                                        Cargar documento
                                                    </label>
                                                    <input class="form-control" type="file" name="imagen">
                                                    <!--aqui se guardan el id del cliente -->
                                                    <input type="hidden" class="idsOcultos" name="fkImagenes" id="cargaId">
                                                </div>
                                                <div class="btn-group col-2" role="group">
                                                    <button
                                                        name="gIdentificacion"
                                                        type="submit"
                                                    ...
                                                    <button type="button" class="btn btn-danger col-2 btn-sm" id="dltIdentificacion">
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            width="25"
                                                            height="25"
                                    ...
                                    <div id="imagenComprobante" class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm" id="dltComprobante">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="25"
                                                        height="25"
                            ...
                            <div class="accordion-item">
                                    ...
                                    <div id="imagenFactura" class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm" id="dltFactura">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="25"
                                                        height="25"
                                ...
                                <img id="imgFacturaVer" class="img-fluid" src="" alt="" onload="resizeImg(this, 200, 100)">
                            </div>
                            <div class="accordion-item">
                                <form                                 class="formImagenes"
                                enctype="multipart/form-data"
                                    ...
                                    <div id="imagenTenencias" class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm" id="dltTenencias">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="25"
                                                        height="25"
                                ...
                                <img id="imgTenenciasVer" class="img-fluid" src="" alt="" onload="resizeImg(this, 200, 100)">
                            </div>
                            <div class="accordion-item">
                                <form                                 class="formImagenes"
                                enctype="multipart/form-data"
                                    ...
                                    <div id="imagenEstado" class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm" id="dltEstado">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="25"
                                                        height="25"
                            ...
                            <div class="accordion-item">
                                    ...
                                    <div id="imagenDenuncia" class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm" id="dltDenuncia">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="25"
                                                        height="25"
                                ...
                                <img id="imgDenunciaVer" class="img-fluid" src="" alt="" onload="resizeImg(this, 200, 100)">
                            </div>
                            <div class="accordion-item">
                                <form                                 class="formImagenes"
                                enctype="multipart/form-data"
                                ...
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                                    <button id="acordeonAcreditacion" onclick="mortrarImagen()"
                                        class="accordion-button collapsed"
                                        type="button"
                                        data-bs-toggle="collapse"
                                        data-bs-target="#acreditacion"
                                        aria-expanded="false"
                                        aria-controls="collapseThree"
                                    >
                                        Acreditacion
                                    ...
                                    <div id="imagenAcreditacion" class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm" id="dltAcreditacion">
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="25"
                                                        height="25"
                                ...
                                <img id="imgAcreditacionVer" class="img-fluid" src="" alt="" onload="resizeImg(this, 200, 100)">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
