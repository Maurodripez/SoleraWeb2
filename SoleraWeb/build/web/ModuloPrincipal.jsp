...
<html lang="en">
    ...
    <body>
            ...
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseOne"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div id="collapseOne"
                                 class="accordion-collapse collapse show col-3"
            ...
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseThree"
                    ...
                    <div class="accordion-body">
                                    ...
                                    <div class="col" name="SearchButtonGeneral">
                                        ...
                                        <form class="form-search float-end">
                                            <div class="input-group">
                                                <input class="form-control"
                                                       maxlength="128"
                                                       placeholder="hola" size="15"
                                                       type="text"
                                                       onkeyup="buscarPoliza()"
                                                       id="txtBuscarPoliza" />
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <!--scripts para la busqyueda con ajax-->
        ...
        <div class="modal fade" name="nombreModal" id="staticBackdrop"
                        ...
                        <div class="accordion accordion-flush"
                            ...
                            <form id="GuardarDatosAsegurado">
                                ...
                                <input type="hidden" id="idOculto"
                                       name="idEditableActual" value="">
                                <!--centrar texto con esta funcion-->
                                <div style="text-align: center">
                                    <button onclick="GuardarRegistros()"
                                            class="btn btn-info">
                                        Guardar Datos
                                    </button>
                                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="progress">
                                <div id="progresoDocsAprobados" class="progress-bar" role="progressbar" aria-label="Example with label"
                                     style="width: 50%; height: 20px;" aria-valuenow="25" aria-valuemin="0"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-target="#staticBackdrop" data-bs-toggle="modal">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
