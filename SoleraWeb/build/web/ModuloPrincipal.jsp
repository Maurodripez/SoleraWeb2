                    ...
                    <% DiasEsperandoRespuesta deRespuesta=new DiasEsperandoRespuesta();%>
                        <% Conexion conexion=new Conexion();%>
                            <% MostrarDatosServlet mdServlet=new MostrarDatosServlet();%>
                                ...
                                <div class="accordion p-4" id="accordionPanelsStayOpenExample">
                                                ...
                                                <div class="row">
                                                    <div id="collapseOne" class="accordion-collapse collapse show col-3"
                                                        ...
                                                        <div class="card 1" style="width: 18rem">
                                                            ...
                                                            <button id="txtBuscar0a2" class="btn btn-primary"
                                                                type="button" data-bs-toggle="collapse"
                                                                data-bs-target=".collapseresultados"
                                                                aria-expanded="false"
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show col-3"
                                                        ...
                                                        <div class="card 2" style="width: 18rem">
                                                            ...
                                                            <button id="txtBuscar3a5" class="btn btn-primary"
                                                                type="button" data-bs-toggle="collapse"
                                                                data-bs-target=".collapseresultados"
                                                                aria-expanded="false"
                                                                aria-controls="multiCollapseExample1 multiCollapseExample2">Mostrar
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show col-3"
                                                        ...
                                                        <div class="card 3" style="width: 18rem">
                                                            ...
                                                            <button id="txtBuscar6a14" class="btn btn-primary"
                                                                type="button" data-bs-toggle="collapse"
                                                                data-bs-target=".collapseresultados"
                                                                aria-expanded="false"
                                                                aria-controls="multiCollapseExample1 multiCollapseExample2">Mostrar
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show col-3"
                                                        ...
                                                        <div class="card 4" style="width: 18rem">
                                                            ...
                                                            <button id="txtBuscarMas15" class="btn btn-primary"
                                                                type="button" data-bs-toggle="collapse"
                                                                data-bs-target=".collapseresultados"
                                                                aria-expanded="false"
                                                                aria-controls="multiCollapseExample1 multiCollapseExample2">Mostrar
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="panelsStayOpen-collapseThree"
                                            class="accordion-collapse collapse collapseresultados"
                                                        ...
                                                        <form class="form-search float-end">
                                                            <div class="input-group">
                                                                <input id="txtBtnGeneralBuscar"
                                                                    onkeyup="busquedaGeneral()" class="form-control"
                                                                    maxlength="128" placeholder="Buscar" size="35"
                                                                    type="text" />
                                                                        ...
                                                                        <div class="input-group">
                                                                            <p class="card-text">
                                                                                <input class="form-control"
                                                                                    maxlength="128"
                                                                                    id="txtBuscarIdRegistro"
                                                                                    onkeyup="buscarId()"
                                                                                    placeholder="Buscar" size="15"
                                                                                    type="text" />
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <p class="card-text">
                                                                                        <input class="form-control"
                                                                                            ...
                                                                                            onkeyup="buscarDiasTranscurridos()"
                                                                                            placeholder="Buscar"
                                                                                            size="15" type="text" />
                                                                                    </p>
                                                                                </div>
                                                                    ...
                                                                    <form class="form-search float-end">
                                                                        <div class="input-group">
                                                                            <input class="form-control" maxlength="128"
                                                                                placeholder="Buscar" size="15"
                                                                                type="text" id="txtBuscarFechaInicio"
                                                                ...
                                                                <div class="col" name="SearchButtonFechas">
                                                                    ...
                                                                    <form class="form-search float-end">
                                                                        <div class="input-group">
                                                                            <input class="form-control" maxlength="128"
                                                                                placeholder="Buscar" size="15"
                                                                                type="text" id="txtBuscarSiniestro"
                                                                ...
                                                                <div class="col" name="SearchButtonGeneral">
                                                                    ...
                                                                    <form class="form-search float-end">
                                                                        <div class="input-group">
                                                                            <input class="form-control" maxlength="128"
                                                                                placeholder="Buscar" size="15"
                                                                                type="text" onkeyup="buscarPoliza()"
                                                                                id="txtBuscarPoliza" />
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                ...
                                                                <div class="col" name="SearchButtonGeneral">
                                                                    ...
                                                                    <form class="form-search float-end">
                                                                        <div class="input-group">
                                                                            <input class="form-control" maxlength="128"
                                                                                placeholder="Buscar" size="15"
                                                                                type="text" onkeyup="buscarAsegurado()"
                                ...
                                <div class="modal fade" name="nombreModal" id="staticBackdrop" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="btn-group" role="group"
                                                    ...
                                                    <label class="btn btn-outline-primary" for="btnradio1"><svg
                                                    ...
                                                    <button type="button" onclick="mostrarDocsAprobados()"
                                                        class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#cargaDocumentos">
                                                        Documentos
                                                    </button>

                                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio3"
                                                        autocomplete="off">
                                                    <label class="btn btn-outline-primary" for="btnradio3"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                            fill="currentColor" class="bi bi-journal"
                                                            viewBox="0 0 16 16">
                                                            <path
                                                    ...
                                                    <input type="radio" class="btn-check" name="btnradio" id="btnradio4"
                                                        autocomplete="off">
                                                    <label class="btn btn-outline-primary" for="btnradio4"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <button onclick="cambiarVerdadero(this.id)" type="button"
                                                ...
                                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                                    ...
                                                    <form id="GuardarDatosAsegurado">
                                                                ...
                                                                <div class="accordion-body">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                <label class="input-group-text fw-bold"
                                                                                    ...
                                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                                        width="30" height="30"
                                                                                        fill="currentColor"
                                                                                        class="bi bi-plus-square-fill p-1"
                                                                                        viewBox="0 0 16 16">
                                                                                        <path
                                                                    ...
                                                                    <div class="row 2">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input id="datosAudatex" type="text"
                                                                                    class="form-control"
                                                                    ...
                                                                    <div class="row 3">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input id="ubicacionTaller" type="text"
                                                                                    class="form-control"
                                                                    ...
                                                                    <div class="row 4">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <select id="regimenFiscal"
                                                                                    ...
                                                                                    <option
                                                                                        value="Persona fisica con actividad empresarial">
                                                                                        Persona fisica con
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input id="passwordExterno" type="text"
                                                                                    class="form-control"
                                                                                    name="txtPassExterno">
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row 4 p-2">
                                                                        <label id="txtcomentarios">Comentarios
                                                                            del
                                                                            cliente</label>
                                                                        <input id="comentariosCliente" type="text"
                                                                            class="form-control"
                                                                            name="txtComentariosCliente"
                                                                    ...
                                                                    <div class="row 1">
                                                                        ...
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="modelo" type="text"
                                                                                class="form-control" name="txtAño">
                                                                        </div>
                                                                        <div class="input-group mb-3 col">
                                                                            <label class="input-group-text fw-bold"
                                                                                for="inputGroupSelect01">
                                                                            ...
                                                                            <input id="placas" type="text"
                                                                                class="form-control" name="txtPlacas">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row 2">
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="numSerie" type="text"
                                                                                class="form-control" name="txtNumSerie">
                                                                        </div>
                                                                        <div class="input-group mb-3 col">
                                                                            <label class="input-group-text fw-bold"
                                                                                for="inputGroupSelect01">
                                                                            ...
                                                                            <input id="valIndemnizacion" type="text"
                                                                                class="form-control"
                                                                        ...
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="valComercial" type="text"
                                                                                class="form-control"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="row 1">
                                                                        ...
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="telPrincipal" type="text"
                                                                        ...
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="telSecundario" type="text"
                                                                                class="form-control"
                                                                    ...
                                                                    <div class="row 2">
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="contacto" type="text"
                                                                                class="form-control" name="txtContacto">
                                                                        </div>
                                                                        <div class="input-group mb-3 col">
                                                                            <label class="input-group-text fw-bold"
                                                                                for="inputGroupSelect01">
                                                                        ...
                                                                        <div class="input-group mb-3 col">
                                                                            ...
                                                                            <input id="telContacto" type="text"
                                                                                class="form-control"
                                                                                name="txtTelContacto">
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <input type="hidden" id="idOculto" name="idEditableActual"
                                                            value="">
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div id="datosSeguimiento">
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <input id="txtComentSeguimiento" type="text"
                                                                            class="form-control"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <select class="form-select"
                                                                                    id="txtEstatusSeguimiento">
                                                                                    <option selected>Selecciona...
                                                                                    </option>
                                                                                    <option
                                                                                        value="Con contacto sin documentos">
                                                                    ...
                                                                    <div style="text-align: center">
                                                                        <button id="insertarSeguimiento"
                                                                            onclick="InsertarSeguimiento()"
                                                                            class="btn btn-info">
                                ...
                                <!-- Modal Documentos-->
                                <div class="modal fade" id="cargaDocumentos" data-bs-backdrop="static"
                                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="progress">
                                                        <div id="progresoDocsAprobados" class="progress-bar"
                                                            role="progressbar" aria-label="Example with label"
                                                            style="width: 50%; height: 20px;" aria-valuenow="25"
                                                ...
                                                <div class="row">
                                                            ...
                                                            <ul class="list-group list-group-flush">
                                                                <li class="list-group-item list-group-item-sm">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        value="" id="checkboxIdentificacion">
                                                                ...
                                                                <li class="list-group-item list-group-item-sm">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        value="" id="checkboxInfoAdicional">
                                                                    <label class="form-check-label"
                                                                        for="flexCheckDefault">
                                                                ...
                                                                <li class="list-group-item list-group-item-sm">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        value="" id="checkboxAcreditacion">
                                                                    <label class="form-check-label"
                                                                        for="flexCheckDefault">
                                                                        Acreditacion
                                                                    </label>
                                                                </li> <button id="btnDocsAprobados"
                                                                    onclick="guardarDocsAprobados(this.id)"
                                                                    type="button"
                                                    ...
                                                    <div class="col-8">
                                                        <form method="post" action="GuardadoImagenesServlet"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <input id="nombreArchivo" name="archivo"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div>
                                                    <select name="tipoArchivo" id="nombreDocVideo"
                                                        class="form-select form-select-sm"
                                                        aria-label="Default select example">
                                                        <option selected>Selecciona...</option>
