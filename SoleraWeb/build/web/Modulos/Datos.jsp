                                                ...
                                                <div class="row 1">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="afectado" class="form-select"
                                                                name="txtAfectado">
                                                                <option selected>
                                                                    Selecciona...
                                                                </option>
                                                ...
                                                <div class="row 2">
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="tipoDeCaso" class="form-select"
                                                                name="txtTipoCaso">
                                                                <option selected>
                                                                    Selecciona...
                                                                </option>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group date" id="datepicker2">
                                                            ...
                                                            <span class="input-group-append">
                                                                <input id="fechaSiniestro" name="txtFechaSiniestro"
                                                ...
                                                <div class="row 3">
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="estado" class="form-select" name="txtEstado"
                                                                required>
                                                                <option selected>
                                                                    Selecciona...
                                                                </option>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="ciudad" class="form-select" name="txtCiudad"
                                                                required>
                                                                <option selected>
                                                                    Selecciona...
                                                                </option>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="region" class="form-select" name="txtRegion"
                                                                required>
                                                                <option selected>
                                                                    Todos-Ninguna
                                                                </option>
                                                ...
                                                <div class="row 4">
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="financiado" class="form-select"
                                                                name="txtFinanciado">
                                                                <option selected>
                                                                    Selecciona...
                                                                </option>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select id="estatusCliente" class="form-select"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row 1">
                                                    ...
                                                    <div class="input-group mb-3 col">
                                                        ...
                                                        <input id="placas" type="text" class="form-control"
                                                            name="txtPlacas">
                                                    </div>
                                                </div>
                                                <div class="row 2">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="input-group date" id="datepicker3">
                                                            ...
                                                            <span class="input-group-append">
                                                                <input id="txtFechaSeguimiento" name="txtFechaCarga"
                                                                    type="text" placeholder="Fecha" autocomplete="off">
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group date" id="datepicker4">
                                                            ...
                                                            <span class="input-group-append">
                                                                <input id="txtFechaPrimEnvDocs" name="txtFechaCarga"
                                                                    type="text" placeholder="Fecha">
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group date" id="datepicker5">
                                                            ...
                                                            <span class="input-group-append">
                                                                <input id="txtFechaIntExp" name="txtFechaCarga"
                                                                    type="text" placeholder="Fecha">
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group date" id="datepicker6">
                                                            ...
                                                            <span class="input-group-append">
                                                                <input id="txtFechaFactServ" name="txtFechaCarga"
                                                                    type="text" placeholder="Fecha">
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="input-group date" id="datepicker7">
                                                            ...
                                                            <span class="input-group-append">
                                                                <input id="txtFechaTermino" name="txtFechaCarga"
                                                                    type="text" placeholder="Fecha">
                                                            </span>
                                                        </div>
                                                    </div>
