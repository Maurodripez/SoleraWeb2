...
<body class="p-2">
    <nav class="navbar bg-light p-3">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h1">Centro de control para usuarios</span>
        </div>
    </nav>
    <div name="RecuperarId" id="CambioId">
    </div>
    <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalMensajesLabel">Centro de mensajes</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="comentarios" class="form-label">Escribe el mensaje que quieres enviar</label>
                            <textarea type="text" class="form-control" id="comentarios" rows="3" minlength=5></textarea>
                        </div>
                        <label id="EnviarMensError"></label>
                        <button id="EnviarComentario" onclick="GuardarComent()" type="button"
    ...
    <div class="modal fade modal-lg" id="modalDocumentos" tabindex="-1" aria-labelledby="modalDocumentosLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalDocumentosLabel">Documentos</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="accordion" id="accordionDocumentos">
                        <form enctype="multipart/form-data" method="post" id="cargaDocs" onsubmit="return userSubmit()">
                            <div class="accordion-item">
                                ...
                                <div id="identifiacion" class="accordion-collapse collapse show"
                                    aria-labelledby="headingOne" data-bs-parent="#accordionDocumentos">
                                    <div id="imagenIdentificacion" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgIdentificacion" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgIdentificacion">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gIdentificacion" type="submit"
                                                    class="botonGuardar btn btn-primary col-2 btn-sm"
                                                    id="imgIdentificacion"><svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltIdentificacion"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="comprobante" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div id="imagenComprobante" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgComprobante" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgComprobante">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gComprobante" type="submit"
                                                    class="botonGuardar btn btn-primary col-2 btn-sm"
                                                    id="imgComprobante"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="25" height="25" fill="currentColor"
                                                        class="bi bi-cloud-arrow-up" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                            d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" />
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltComprobante"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="25" height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="infoadicional" class="accordion-collapse collapse"
                                    aria-labelledby="headingThree" data-bs-parent="#accordionDocumentos">
                                    <div id="imagenInfo" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgInfo" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgInfo">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gInfo" type="submit"
                                                    class="botonGuardarbtn btn-primary col-2 btn-sm" id="imgInfo"><svg
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltInfo"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="factura" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    ...
                                    <div id="imagenFactura" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgFactura" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgFactura">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gFactura" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm"
                                                    id="imgFactura"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                            d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" />
                                                        <path
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltFactura"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#tenencias" aria-expanded="false" aria-controls="collapseThree">
                                        Tenencias
                                    </button>
                                </h2>
                                <div id="tenencias" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    ...
                                    <div id="imagenTenencias" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgTenencias" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgTenencias">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gTenencias" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm"
                                                    id="imgTenencias"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                            d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" />
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltTenencias"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#baja" aria-expanded="false" aria-controls="collapseThree">
                                        Baja
                                    </button>
                                </h2>
                                <div id="baja" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    ...
                                    <div id="imagenBaja" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgBaja" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgBaja">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gBaja" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm" id="imgBaja"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltBaja"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#estadoCuenta" aria-expanded="false"
                                        aria-controls="collapseThree">
                                        Estado de cuenta
                                    </button>
                                </h2>
                                <div id="estadoCuenta" class="accordion-collapse collapse"
                                    ...
                                    <div id="imagenEstado" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgEstado" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgEstado">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gEstado" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm" id="imgEstado"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltEstado"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#denuncias" aria-expanded="false" aria-controls="collapseThree">
                                        Denuncia
                                    </button>
                                </h2>
                                <div id="denuncias" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                    ...
                                    <div id="imagenDenuncia" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgDenuncia" class="form-label">Cargar
                                                    documento</label>
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                <button name="gDenuncia" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm"
                                                    id="imgDenuncia"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                            d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" />
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltDenuncia"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="acreditacion" class="accordion-collapse collapse"
                                    ...
                                    <div id="imagenAcreditacion" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                <label for="imgAcreditacion" class="form-label">Cargar
                                                    documento</label>
                                                <input class="form-control  " type="file" name="imgAcreditacion">
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gAcreditacion" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm"
                                                    id="imgAcreditacion"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="25" height="25" fill="currentColor"
                                                        class="bi bi-cloud-arrow-up" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                            d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2z" />
                                                ...
                                                <button type="button" class="btn btn-danger col-2 btn-sm"
                                                    id="dltAcreditacion"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="25" height="25" fill="currentColor" class="bi bi-trash3"
                                                        viewBox="0 0 16 16">
                                                        <path
                                                            d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5ZM11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H2.506a.58.58 0 0 0-.01 0H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1h-.995a.59.59 0 0 0-.01 0H11Zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5h9.916Zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47ZM8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5Z" />
