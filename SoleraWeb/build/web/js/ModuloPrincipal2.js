    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        for (let i = 0; i < sinCodificado.length - 1; i++) {
          ...
          alert(sinCodificado2[0]);
          alert(sinCodificado2[1]);
          alert(sinCodificado2[2]);
          alert(sinCodificado2[3]);
        ...
        $.ajax({
          ...
          success: function (result) {
            ...
            if (sinPuntos[1] === "txt") {
              ...
              console.log(sinComas[0]);
              console.log(sinComas[1]);
              console.log(sinComas[2]);
              let imagen = document.getElementById("docSeleccionado");
              iframe.style.display = "none";
              imagen.setAttribute(
                "src",
