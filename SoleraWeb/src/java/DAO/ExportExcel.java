    ...
    public String ExcelSiniestros(String fechaInicio, String fechafinal) throws WriteException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Label numSiniestro = new Label(0, row, "numSiniestro");
                Label poliza = new Label(1, row, "poliza");
                Label afectado = new Label(2, row, "afectado");
                Label tipoDeCaso = new Label(3, row, "tipoDeCaso");
                Label cobertura = new Label(4, row, "cobertura");
                Label fechaSiniestro = new Label(5, row, "fechaSiniestro");
                Label estado = new Label(6, row, "estado");
                Label ciudad = new Label(7, row, "ciudad");
                Label ubicacionTaller = new Label(8, row, "ubicacionTaller");
                Label financiado = new Label(9, row, "financiado");
                Label regimenFiscal = new Label(10, row, "regimenFiscal");
                Label estatusCliente = new Label(11, row, "estatusCliente");
                Label comentariosCliente = new Label(12, row, "comentariosCliente");
                Label datosAudatex = new Label(13, row, "datosAudatex");
                Label passwordExterno = new Label(14, row, "passwordExterno");
                Label fechaCarga = new Label(15, row, "fechaCarga");
                Label fechaDecreto = new Label(16, row, "fechaDecreto");
                Label usuarioCarga = new Label(17, row, "usuarioCarga");
                Label estatusSeguimientoSin = new Label(18, row, "estatusSeguimientoSin");
                Label usuarioAsignadoSin = new Label(19, row, "usuarioAsignadoSin");
                Label fechaAsignacion = new Label(20, row, "fechaAsignacion");
                Label marca = new Label(21, row, "marca");
                Label tipo = new Label(22, row, "tipo");
                Label modelo = new Label(23, row, "modelo");
                Label numSerie = new Label(24, row, "numSerie");
                Label valorIndemnizacion = new Label(25, row, "valorIndemnizacion");
                Label valorComercial = new Label(26, row, "valorComercial");
                Label placas = new Label(27, row, "placas");
                Label telefonoPrincipal = new Label(28, row, "telefonoPrincipal");
                Label telefonosecundario = new Label(29, row, "telefonosecundario");
                Label contacto = new Label(30, row, "contacto");
                Label correo = new Label(31, row, "correo");
                Label asegurado = new Label(32, row, "asegurado");
                Label correoContacto = new Label(33, row, "correoContacto");
                Label telContacto = new Label(34, row, "telContacto");
                Label usuario = new Label(35, row, "usuario");
                Label fechaseguimiento = new Label(36, row, "fechaseguimiento");
                Label estatusSeguimiento = new Label(37, row, "estatusSeguimiento");
                Label comentarios = new Label(38, row, "comentarios");
                Label estacionPrincipal = new Label(39, row, "estacionPrincipal");
                Label subEstatus = new Label(40, row, "subEstatus");
                Label respuestaSolera = new Label(41, row, "respuestaSolera");
                Label personaContactada = new Label(42, row, "personaContactada");
                Label tipodePersona = new Label(43, row, "tipodePersona");
                Label contactoSeg = new Label(44, row, "contactoSeg");
                Label integraciondeexpediente = new Label(45, row, "integraciondeexpediente");
                Label facturaciondeservicio = new Label(46, row, "facturaciondeservicio");
                Label termino = new Label(47, row, "termino");
                Label fechaasigncion = new Label(48, row, "fechaasigncion");
                Label usuarioAsignado = new Label(49, row, "usuarioAsignado");
                Label region = new Label(50, row, "region");
                row++;
                r = "3";
                try {
                    excelSheet.addCell(numSiniestro);
